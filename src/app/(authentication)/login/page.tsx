...
import { faAngry, faRightToBracket } from "@fortawesome/free-solid-svg-icons"
import Logo from '@/components/Logo'
// import { Metadata } from 'next/dist/lib/metadata/types/metadata-interface'

// export const metadata: Metadata = {
//   title: "SignIn Page | TourAbi - Admin Panel",
//   description: "This is Next.js Signin Page TourAbi Admin Panel",
// }

const SignIn: React.FC = () => {
  return (
    <>
      <title>SignIn Page | TourAbi - Admin Panel</title>
      <meta name="description" content="This is Next.js Signin Page TourAbi Admin Panel" />
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full md:max-w-[40%] md:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Logo width={176} />
              <h2 className="text-3xl">
                SignIn Page | TourAbi - Admin Panel
              </h2>
          ...
          <div className="w-full md:max-w-[40%] border-stroke dark:border-strokedark xl:w-1/3 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">TourAbi Admin Panel</span>
